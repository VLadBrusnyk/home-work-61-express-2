...
Cервер на Node.js + Express. Проект використовує базові мідлвари для логування, аутентифікації, валідації, доступу до статей і обробки помилок у невеликій MVC-структурі (routes/controllers/middlewares).
